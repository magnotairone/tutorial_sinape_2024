...
O código fonte completo usado neste tutorial está disponível no diretório `codigos/` [neste repositório](https://github.com/magnotairone/tutorial_sinape_2024/tree/main/codigos) no GitHub. 
Os slides usados durante a apresentação podem ser encontrados [neste link](https://magnotairone.github.io/tutorial_sinape_2024/slides#/title-slide).
